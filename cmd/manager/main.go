...
import (
	...
	"github.com/agill17/s3-operator/pkg/controller"
	"github.com/agill17/s3-operator/version"
...
func main() {
	...
	err = leader.Become(ctx, "s3-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	addMetrics(ctx, cfg, "s3-operator")
